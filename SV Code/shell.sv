...
//core
(* dont_touch = "true" *) logic [31:0] instrDUnprocessed, instrD, read_data;
...
decompressionunit decompressionunit(.instrD(instrDUnprocessed),.compressed(compressed),.processedInstrD(instrD));
