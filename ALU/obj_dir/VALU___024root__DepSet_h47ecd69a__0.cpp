...
VL_INLINE_OPT void VALU___024root___nba_sequent__TOP__1(VALU___024root* vlSelf) {
    ...
    // Body
    vlSelf->ALU__DOT__divider__DOT__count = vlSelf->__Vdly__ALU__DOT__divider__DOT__count;
    vlSelf->ALU__DOT__divider__DOT__Qp = vlSelf->__Vdly__ALU__DOT__divider__DOT__Qp;
    vlSelf->ALU__DOT__divider__DOT__Qm = vlSelf->__Vdly__ALU__DOT__divider__DOT__Qm;
    vlSelf->divide_running = vlSelf->__Vdly__divide_running;
    vlSelf->ALU__DOT__divider__DOT__regPA[0U] = vlSelf->__Vdly__ALU__DOT__divider__DOT__regPA[0U];
    vlSelf->ALU__DOT__divider__DOT__regPA[1U] = vlSelf->__Vdly__ALU__DOT__divider__DOT__regPA[1U];
    vlSelf->ALU__DOT__divider__DOT__regPA[2U] = vlSelf->__Vdly__ALU__DOT__divider__DOT__regPA[2U];
    vlSelf->ALU__DOT__multiplier__DOT__state = vlSelf->__Vdly__ALU__DOT__multiplier__DOT__state;
    vlSelf->ALU__DOT__multdiv_rst = vlSelf->__Vdly__ALU__DOT__multdiv_rst;
...
VL_INLINE_OPT void VALU___024root___nba_sequent__TOP__4(VALU___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VALU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU___024root___nba_sequent__TOP__4\n"); );
    // Body
...
void VALU___024root___nba_sequent__TOP__2(VALU___024root* vlSelf);
