...
VL_ATTR_COLD void VALU_carry_lookahead_adder___stl_sequent__TOP__ALU__DOT__shift_multiplier__DOT__adder_lower__0(VALU_carry_lookahead_adder* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          VALU_carry_lookahead_adder___stl_sequent__TOP__ALU__DOT__shift_multiplier__DOT__adder_lower__0\n"); );
    // Init
...
VL_ATTR_COLD void VALU_carry_lookahead_adder___stl_sequent__TOP__ALU__DOT__shift_multiplier__DOT__adder_upper__0(VALU_carry_lookahead_adder* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VALU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VALU_carry_lookahead_adder___stl_sequent__TOP__ALU__DOT__shift_multiplier__DOT__adder_upper__0\n"); );
    // Body
    vlSelf->block0__DOT__a = (0xfU & (vlSelf->a >> 0U));
    vlSelf->block0__DOT__slice0__DOT__a = (1U & (vlSelf->a 
                                                 >> 0U));
