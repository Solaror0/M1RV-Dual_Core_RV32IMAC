...
VL_ATTR_COLD void Vdivider___024root___ctor_var_reset(Vdivider___024root* vlSelf) {
    ...
    vlSelf->divider__DOT__pNorm = VL_RAND_RESET_Q(64);
    vlSelf->divider__DOT__dNormExt = VL_RAND_RESET_Q(64);
    ...
    vlSelf->divider__DOT__dC = VL_RAND_RESET_Q(64);
    vlSelf->divider__DOT__pS = VL_RAND_RESET_Q(64);
    vlSelf->divider__DOT__pC = VL_RAND_RESET_Q(64);
    vlSelf->divider__DOT__pNS = VL_RAND_RESET_Q(64);
    vlSelf->divider__DOT__pNC = VL_RAND_RESET_Q(64);
    vlSelf->divider__DOT__pTrunc = VL_RAND_RESET_Q(64);
    vlSelf->divider__DOT__dLS = VL_RAND_RESET_Q(64);
    vlSelf->divider__DOT__dM = VL_RAND_RESET_Q(64);
    vlSelf->divider__DOT__dMLS = VL_RAND_RESET_Q(64);
