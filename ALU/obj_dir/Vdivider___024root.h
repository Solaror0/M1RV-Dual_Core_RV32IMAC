...
class alignas(VL_CACHE_LINE_BYTES) Vdivider___024root final : public VerilatedModule {
  public:
    ...
    VlWide<3>/*65:0*/ divider__DOT__pNorm;
    VlWide<3>/*65:0*/ divider__DOT__dNormExt;
    IData/*31:0*/ divider__DOT__dNorm;
    VlWide<3>/*65:0*/ divider__DOT__pS;
    VlWide<3>/*65:0*/ divider__DOT__pC;
    VlWide<3>/*65:0*/ divider__DOT__pNS;
    VlWide<3>/*65:0*/ divider__DOT__pNC;
    VlWide<3>/*65:0*/ divider__DOT__pTrunc;
    VlWide<3>/*65:0*/ divider__DOT__pNow;
    VlWide<3>/*65:0*/ divider__DOT__pNext;
    VlWide<3>/*65:0*/ divider__DOT__dC;
    VlWide<3>/*65:0*/ divider__DOT__dLS;
    VlWide<3>/*65:0*/ divider__DOT__dM;
    VlWide<3>/*65:0*/ divider__DOT__dMLS;
