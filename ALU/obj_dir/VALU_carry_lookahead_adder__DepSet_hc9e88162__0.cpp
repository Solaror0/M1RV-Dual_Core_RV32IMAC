...
VL_INLINE_OPT void VALU_carry_lookahead_adder___nba_sequent__TOP__ALU__DOT__multiplier__DOT__fast_adder_lower__0(VALU_carry_lookahead_adder* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VALU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VALU_carry_lookahead_adder___nba_sequent__TOP__ALU__DOT__multiplier__DOT__fast_adder_lower__0\n"); );
    // Body
    vlSelf->block0__DOT__a = (0xfU & (vlSelf->a >> 0U));
    vlSelf->block0__DOT__slice0__DOT__a = (1U & (vlSelf->a 
                                                 >> 0U));
...
VL_INLINE_OPT void VALU_carry_lookahead_adder___nba_sequent__TOP__ALU__DOT__multiplier__DOT__fast_adder_lower__1(VALU_carry_lookahead_adder* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VALU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VALU_carry_lookahead_adder___nba_sequent__TOP__ALU__DOT__multiplier__DOT__fast_adder_lower__1\n"); );
    // Init
    CData/*3:0*/ __Vcellout__block0__s;
    __Vcellout__block0__s = 0;
    CData/*3:0*/ __Vcellout__block1__s;
...
VL_INLINE_OPT void VALU_carry_lookahead_adder___nba_sequent__TOP__ALU__DOT__multiplier__DOT__fast_adder_upper__0(VALU_carry_lookahead_adder* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VALU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VALU_carry_lookahead_adder___nba_sequent__TOP__ALU__DOT__multiplier__DOT__fast_adder_upper__0\n"); );
    // Body
    vlSelf->b_in = ((IData)(vlSelf->Subtract) ? (~ vlSelf->b)
                     : vlSelf->b);
    vlSelf->block0__DOT__a = (0xfU & (vlSelf->a >> 0U));
...
VL_INLINE_OPT void VALU_carry_lookahead_adder___nba_sequent__TOP__ALU__DOT__multiplier__DOT__fast_adder_upper__1(VALU_carry_lookahead_adder* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VALU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VALU_carry_lookahead_adder___nba_sequent__TOP__ALU__DOT__multiplier__DOT__fast_adder_upper__1\n"); );
    // Init
    CData/*3:0*/ __Vcellout__block0__s;
    __Vcellout__block0__s = 0;
    CData/*3:0*/ __Vcellout__block1__s;
